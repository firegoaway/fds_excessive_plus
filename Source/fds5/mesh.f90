...
TYPE MESH_TYPE
   ...
   REAL(EB), POINTER, DIMENSION(:,:,:) :: PRHS,H_PREV
   ...
   ! SOAP solver storage (allocated only when PRES_METHOD=='SOAP')
   REAL(EB), POINTER, DIMENSION(:,:,:) :: SOAP_PRHS_PREV,SOAP_HP_PREV
   LOGICAL :: SOAP_FIRST_CALL
   ...
   REAL(EB) :: DT,DT_PREV,DT_NEXT,DT_INIT
    REAL(EB) :: CFL,DIVMX,DIVMN,VN,RESMAX,PART_CFL,CFL_ADV,CFL_DP
   ...
   INTEGER :: MESH_LEVEL
   LOGICAL :: EMBEDDED_MESH_FLAG = .FALSE.
   INTEGER :: PARENT_MESH = 0
   INTEGER :: EMBEDDED_RATIO = 2
   ...
   REAL(EB), POINTER, DIMENSION(:) :: ALPHA_CF_W
   LOGICAL, POINTER, DIMENSION(:) :: CUT_FACE_FLAG
   REAL(EB), POINTER, DIMENSION(:,:) :: CFACE_CEN
   REAL(EB), POINTER, DIMENSION(:,:,:) :: VOLUME_FACTOR
   ...
   CHARACTER(200), POINTER, DIMENSION(:) :: STRING
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: SOAP_PRHS_PREV,SOAP_HP_PREV
LOGICAL, POINTER :: SOAP_FIRST_CALL
...
REAL(EB), POINTER :: CFL,DIVMX,DIVMN,VN,RESMAX,PART_CFL,CFL_ADV,CFL_DP
...
SOAP_PRHS_PREV => M%SOAP_PRHS_PREV
SOAP_HP_PREV   => M%SOAP_HP_PREV
SOAP_FIRST_CALL=> M%SOAP_FIRST_CALL
...
U_TAU=>M%U_TAU
E_WALL=>M%E_WALL
ALPHA_CF_W=>M%ALPHA_CF_W
CUT_FACE_FLAG=>M%CUT_FACE_FLAG
CFACE_CEN=>M%CFACE_CEN
