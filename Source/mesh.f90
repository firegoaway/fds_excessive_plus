...
TYPE MESH_TYPE
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: CCC     !< Combustion Completeness Coefficient
   ...
   LOGICAL, ALLOCATABLE, DIMENSION(:,:,:) :: SOLID_CELL               !< Direct 3D array cache of CELL%SOLID for hot-loop performance (TIER 7.2)
   ...
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: WALL_MLR_SUM  !< Sum of MLR from all surfaces for each cell (kg/s)
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: VENT_MLR_SUM  !< Sum of MLR from all VENTs for each cell (kg/s)

   ! Cached B1 properties for hot paths — avoids 3-level indirection in CHECK_STABILITY, etc.
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: WALL_Q_CON_F_CACHE
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: WALL_RHO_F_CACHE
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: WALL_RDN_CACHE
...
REAL(EB), POINTER, DIMENSION(:,:,:) :: &
   ...
   MU,MU_DNS,TMP,Q,KAPPA_GAS,CHI_R,CCC,QR,QR_W,RADIATION_EMISSION,RADIATION_ABSORPTION,UII,RSUM,D_SOURCE, &
...
LOGICAL, POINTER, DIMENSION(:,:,:) :: SOLID_CELL
...
REAL(EB), POINTER, DIMENSION(:)   :: WALL_Q_CON_F_CACHE,WALL_RHO_F_CACHE,WALL_RDN_CACHE
...
V_GHOST=>M%V_GHOST
W_GHOST=>M%W_GHOST
WALL_Q_CON_F_CACHE=>M%WALL_Q_CON_F_CACHE
WALL_RHO_F_CACHE=>M%WALL_RHO_F_CACHE
WALL_RDN_CACHE=>M%WALL_RDN_CACHE
WALL=>M%WALL
